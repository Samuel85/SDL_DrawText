...
int init()
{
	...
	screen = SDL_CreateRGBSurface(0, 800,600,32, 0xff000000, 0x00ff0000,0x0000ff00, 0x000000ff);
#else
	screen = SDL_CreateRGBSurface(0, 800,600,32, 0x000000ff, 0x0000ff00,0x00ff0000, 0xff000000);
#endif
...
int main()
{
    ...
    // Print some text
    text->print(screen, L"Bienvenido a esta abadía, hermano.\nOs ruego que me sigáis.\nHa sucedido algo terrible.", 10,50);
    
    text->print(screen, "Bienvenido a esta abadía, hermano.\nOs ruego que me sigáis.\nHa sucedido algo terrible.", 10,200);
