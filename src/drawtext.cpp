...
DrawText::DrawText(const char* fontPath, const int fontSize, const SDL_Color& fontColor, int initialCharacter, int finalCharacter) :
	initialCharacter_{ initialCharacter }, finalCharacter_{ finalCharacter }, totalCharacters_{ static_cast<size_t>(finalCharacter_ - initialCharacter_) },
